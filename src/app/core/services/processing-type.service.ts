...
export class ProcessingTypeService {
  ...
  ): Observable<PagedReply<ProcessingType>> {
  ...
  get(studySlug: String, processingTypeSlug: string): Observable<ProcessingType> {
    return this.http.get<ApiReply>(`${this.BASE_URL}/${studySlug}/${processingTypeSlug}`)
  ...
  getById(studyId: String, processingTypeId: string): Observable<ProcessingType> {
    return this.http.get<ApiReply>(`${this.BASE_URL}/id/${studyId}/${processingTypeId}`)
      .pipe(map(this.replyToProcessingType));
  }
  ...
  getInUse(slug: string): Observable<any> {
    return this.http.get<ApiReply>(`${this.BASE_URL}/inuse/${slug}`)
  ...
  add(processingType: ProcessingType): Observable<ProcessingType> {
    ...
    return this.http.post<ApiReply>(`${this.BASE_URL}/${processingType.studyId}`, json)
      .pipe(map(this.replyToProcessingType));
  }

  update(pt: ProcessingType,
  ...
  addOrUpdateAnnotationType(processingType: ProcessingType,
                            annotationType: AnnotationType): Observable<ProcessingType> {
    const json = {
      ...annotationType,
