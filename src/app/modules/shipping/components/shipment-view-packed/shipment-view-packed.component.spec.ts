...
describe('ShipmentViewPageComponent', () => {
  ...
  describe('when tagging the shipment', () => {
    const context: EntityUpdateComponentBehaviour.Context<ShipmentViewPackedComponent> = {};
    ...
    describe.each`
      ...
      ${'CREATED'} | ${'backToCreated'} | ${ShipmentStateTransision.Created} | ${'OK'}
      ${'SENT'}    | ${'tagAsSent'}     | ${ShipmentStateTransision.Sent}    | ${new Date()}
