...
export class StudySelectTypeahead extends EntitySelectTypeahead<Study> {
  constructor(private store$: Store<RootStoreState.State>, resultsMapper: (entities: Study[]) => Study[]) {
    super(resultsMapper);
  }
