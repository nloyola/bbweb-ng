...
export const selectCollectionEventLastRemovedId: MemoizedSelector<object, string> =
  createSelector(selectCollectionEventState, getLastRemovedId);

export const selectCollectionEventSearchActive: MemoizedSelector<object, boolean> =
  createSelector(selectCollectionEventState, getSearchActive);

export const selectCollectionEventLastSearch: MemoizedSelector<object, SearchParams> =
  createSelector(selectCollectionEventState, getLastSearch);
...
export const selectAllCollectionEvents: MemoizedSelector<object, CollectionEvent[]> =
  createSelector(selectCollectionEventState, fromCollectionEvent.selectAll);

export const selectAllCollectionEventEntities =
  createSelector(selectCollectionEventState, fromCollectionEvent.selectEntities);

export const selectCollectionEventSearchRepliesAndEntities =
  createSelector(
...
export const selectCollectionEventLastAdded =
  createSelector(
...
export const selectCollectionEventLastRemoved =
  createSelector(
