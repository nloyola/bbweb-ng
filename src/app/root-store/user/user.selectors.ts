...
export const getSearchReplies = (state: fromUser.State): { [url: string]: PagedReplyEntityIds } =>
  state.searchReplies;
...
export const selectUserSearchActive: MemoizedSelector<object, boolean> = createSelector(
  selectUserState,
  getSearchActive
);

export const selectUserLastSearch: MemoizedSelector<object, SearchParams> = createSelector(
  selectUserState,
  getLastSearch
);
...
export const selectUserCounts: MemoizedSelector<object, UserCounts> = createSelector(
  selectUserState,
  getCounts
);

export const selectUserSearchReplies: MemoizedSelector<
  object,
...
export const selectAllUsers: MemoizedSelector<object, User[]> = createSelector(
  selectUserState,
  fromUser.selectAll
);
...
export const selectUserSearchRepliesAndEntities = createSelector(
