...
export const getCanAddInventoryId = (state: fromShipment.State): string[] => state.canAddSpecimenInventoryIds;

export const getError = (state: fromShipment.State): any => state.error;

export const getSearchReplies = (state: fromShipment.State): { [url: string]: PagedReplyEntityIds } =>
  state.searchReplies;

export const selectShipmentState = createFeatureSelector<fromShipment.State>('shipment');

export const selectShipmentLastAddedId: MemoizedSelector<object, string> = createSelector(
  selectShipmentState,
  getLastAddedId
);

export const selectShipmentLastRemovedId: MemoizedSelector<object, string> = createSelector(
  selectShipmentState,
  getLastRemovedId
);

export const selectShipmentSearchActive: MemoizedSelector<object, boolean> = createSelector(
  selectShipmentState,
  getSearchActive
);

export const selectShipmentLastSearch: MemoizedSelector<object, SearchParams> = createSelector(
  selectShipmentState,
  getLastSearch
);

export const selectCanAddInventoryId: MemoizedSelector<object, string[]> = createSelector(
  selectShipmentState,
  getCanAddInventoryId
);
...
export const selectShipmentSearchReplies: MemoizedSelector<
  object,
...
export const selectAllShipments: MemoizedSelector<object, Shipment[]> = createSelector(
  selectShipmentState,
...
export const selectShipmentSearchRepliesAndEntities = createSelector(
...
export const selectShipmentLastAdded = createSelector(
...
export const selectShipmentLastRemoved = createSelector(
