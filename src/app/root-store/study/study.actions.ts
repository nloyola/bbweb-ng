...
export const getStudyCountsRequest = createAction('[Study] Get Study Count Request');
...
export const getStudyCountsFailure = createAction('[Study] Get Study Count Failure', props<{ error: any }>());
...
export const searchStudiesFailure = createAction('[Study] Search Studies Failure', props<{ error: any }>());
...
export const searchCollectionStudiesSuccess = createAction(
  ...
  props<{ studiesData: StudyStateInfo[] }>()
);
...
export const addStudyRequest = createAction('[Study] Add Study Request', props<{ study: Study }>());

export const addStudySuccess = createAction('[Study] Add Study Success', props<{ study: Study }>());

export const addStudyFailure = createAction('[Study] Add Study Failure', props<{ error: any }>());
...
export const updateStudySuccess = createAction('[Study] Update Study Success', props<{ study: Study }>());

export const updateStudyFailure = createAction('[Study] Update Study Failure', props<{ error: any }>());

export const getStudyRequest = createAction('[Study] Get Study Request', props<{ slug: string }>());

export const getStudySuccess = createAction('[Study] Get Study Success', props<{ study: Study }>());

export const getStudyFailure = createAction('[Study] Get Study Failure', props<{ error: any }>());
